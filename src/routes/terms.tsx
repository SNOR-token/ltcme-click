    ...
    <div className="min-h-screen px-6 py-12 md:py-16">
      <div className="relative max-w-3xl mx-auto card-glass rounded-3xl p-8 md:p-12 neon-page">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>
            Because LTCme.click never takes custody or control of your Litecoin, it does not operate as a money services business (MSB), money transmitter, or currency exchange under U.S. federal law, and does not register as such with FinCEN. You — the user — are the party initiating and controlling any transfer of value. LTCme.click simply displays data and helps you build and sign transactions locally. If any regulator or court ever determines that any function of this software constitutes money transmission, exchange, or another regulated activity, you acknowledge that LTCme.click is provided solely as a non-custodial software tool and that you, not LTCme.click, are the responsible party for any transaction. LTCme.click is not a registered money services business with the Financial Crimes Enforcement Network (FinCEN) and does not hold any state money-transmitter license. Buy / sell on-ramps and off-ramps, where offered, are provided by independent third-party partners who may be licensed and who handle any required KYC/AML and licensing themselves.
          </p>
          ...
          <p>
            Card payments, where offered, are processed by Stripe and subject to Stripe's terms. Crypto payments are non-refundable once confirmed on the Litecoin network. Card subscriptions can be managed or canceled from the billing page; you remain responsible for charges until cancellation takes effect. We do not store full card numbers.
          </p>

          <h2 className="text-foreground text-lg font-semibold">14. No warranty; limitation of liability.</h2>
          <p>
          ...
          <p>
            We may update these Terms from time to time. Material changes will be posted on this page with a new "Last updated" date; your continued use of LTCme.click after changes take effect constitutes acceptance of the revised Terms.
          </p>

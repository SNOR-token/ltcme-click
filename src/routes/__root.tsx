...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Non-custodial Litecoin wallet with a built-in AI companion. Send, receive, buy, and cash out LTC." },
      { name: "author", content: "LTCme.click" },
      { property: "og:title", content: "LTCme.click — Litecoin's AI-powered self-custody wallet" },
      { property: "og:description", content: "Non-custodial Litecoin wallet with a built-in AI companion. Send, receive, buy, and cash out LTC." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "LTCme.click — Litecoin's AI-powered self-custody wallet" },
      { name: "twitter:description", content: "Non-custodial Litecoin wallet with a built-in AI companion. Send, receive, buy, and cash out LTC." },

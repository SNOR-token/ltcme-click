...
const PLANS = [
  { id: "monthly",   name: "Monthly",  price: "$4.99",  usd: 4.99,  period: "/mo",     save: "" },
  { id: "quarterly", name: "3 Months", price: "$9.99",  usd: 9.99,  period: "/3 mo",   save: "Save 33%" },
  { id: "yearly",    name: "Yearly",   price: "$19.99", usd: 19.99, period: "/yr",     save: "Save 67%" },
];
  ...
  return (
    <div className="rounded-2xl border border-primary/30 bg-primary/5 p-3 space-y-2">
      ...
      <p className="text-[11px] text-muted-foreground">
        Wallet features stay free. Pay with Litecoin — sent to the dev address.
      </p>
          ...
          <div className="rounded-xl border border-border bg-background/60 p-2.5 text-xs space-y-2">
            ...
            <div className="flex items-start gap-1.5 pt-1">
              ...
              <p className="text-muted-foreground text-[10px]">
                After sending, email the txid to support to activate. Rate ${ltcUsd.toFixed(2)}/LTC.
              </p>
            </div>
          </div>
        );
